...
1.获取API接口，API是一种可以通过代码固定指令直接互动的一直通信方式。

2.word新建VB模块，使用自己的API key

3.使用。

[word_deepseek.txt](Day2%20Deepseek%E6%8E%A5%E5%85%A5word%201a72daab6476801fb901cbb62f86d111/word_deepseek.txt)
...
Sub DeepSeekV3()
    ...
    ' API Key
    api_key = "sk-kauxfobomopojyjvwllpnyadpswzspvktcxwjgpqirznbxs"
    If api_key = "" Then
        MsgBox "把这句话修改为你的api_key", vbExclamation
        Exit Sub
    End If
